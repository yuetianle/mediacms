# flake8: noqa
"""
Django settings for mediacms project.
...
DJANGO_ROOT = root.path('mediacms')
...
WSGI_APPLICATION = 'mediacms.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///mediacms'),
}
